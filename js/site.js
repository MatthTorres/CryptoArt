// ==========================================================
// CryptoArt — JS compartido: Home (index.html) y Sobre nosotros (about.html)
// Tema oscuro/claro, idioma ES/EN y datos del mercado para el home.
// ==========================================================

const I18N = {
  es: {
    homeTitle: 'CryptoArt — Inicio',
    aboutTitle: 'CryptoArt — Sobre nosotros',
    homeTagline: 'Análisis cripto · Fundamental + Técnico',
    navHome: 'Inicio',
    navAnalysis: 'Cripto',
    navMetals: 'Metales',
    navForex: 'Divisas',
    ...
    metalsDesc: 'Mismo análisis profesional: fundamental, técnico, probabilidades, rango estimado del día y recomendación.',
    ...
    forexTitle: 'Elige una divisa para analizar',
    forexDesc: 'Mismo análisis profesional: fundamental, técnico, probabilidades, rango estimado del día y recomendación.',
    ...
    aboutHeroTitle: 'Sobre CryptoArt',
    aboutHeroText: 'CryptoArt es una plataforma de análisis de criptoactivos que combina datos de mercado en tiempo real con indicadores estadísticos para ofrecerte, cada día, una lectura clara de qué puede pasar con las principales criptomonedas.',
    aboutMissionTitle: 'Nuestra misión',
    aboutMissionText: 'Democratizar el análisis financiero cripto: traducir indicadores complejos en probabilidades y rangos fáciles de entender, para que cualquier persona pueda tomar decisiones informadas y gestionar su riesgo.',
    aboutHowTitle: 'Qué incluye cada análisis',
    aboutHow1: 'Análisis fundamental: sentimiento de mercado, variaciones 24h/7d, índice Miedo y Codicia y capitalización.',
    ...
    aboutSourcesText: 'CoinGecko API (precios, capitalización, volumen y sentimiento de la comunidad), Alternative.me Fear & Greed Index (miedo/codicia del mercado) y TradingView (gráfico en tiempo real). Todos los cálculos se ejecutan en tu navegador, sin servidores intermedios.',
    aboutRiskTitle: 'Aviso de riesgo',
    aboutRiskText: 'CryptoArt no presta asesoría financiera. Los estimados se generan automáticamente a partir de modelos estadísticos y datos públicos, y no garantizan resultados. Las criptomonedas son activos volátiles: nunca inviertas más de lo que puedes permitirte perder y usa siempre stop-loss.',
  },
  en: {
    homeTitle: 'CryptoArt — Home',
    aboutTitle: 'CryptoArt — About us',
    homeTagline: 'Crypto analysis · Fundamental + Technical',
    navHome: 'Home',
    navAnalysis: 'Crypto',
    navMetals: 'Metals',
    navForex: 'Forex',
    ...
    metalsDesc: 'Same professional analysis: fundamental, technical, probabilities, daily estimated range and recommendation.',
    ...
    forexTitle: 'Choose a currency pair to analyze',
    forexDesc: 'Same professional analysis: fundamental, technical, probabilities, daily estimated range and recommendation.',
    ...
    aboutHeroTitle: 'About CryptoArt',
    aboutHeroText: 'CryptoArt is a cryptoasset analysis platform that combines real-time market data with statistical indicators to give you, every day, a clear read on what may happen with the leading cryptocurrencies.',
    aboutMissionTitle: 'Our mission',
    aboutMissionText: 'Democratize crypto financial analysis: turn complex indicators into probabilities and ranges that are easy to understand, so anyone can make informed decisions and manage their risk.',
    aboutHowTitle: 'What each analysis includes',
    aboutHow1: 'Fundamental analysis: market sentiment, 24h/7d changes, Fear & Greed Index and market cap.',
    ...
    aboutSourcesText: 'CoinGecko API (prices, market cap, volume and community sentiment), Alternative.me Fear & Greed Index (market fear/greed) and TradingView (real-time chart). All calculations run in your browser, with no intermediate servers.',
    aboutRiskTitle: 'Risk disclaimer',
    aboutRiskText: 'CryptoArt does not provide financial advice. Estimates are generated automatically from statistical models and public data and do not guarantee results. Cryptocurrencies are volatile assets: never invest more than you can afford to lose and always use a stop-loss.',
  },
};
