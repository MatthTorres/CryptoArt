...
const I18N = {
  es: {
    ...
    aboutSourcesText: 'Trabajamos con proveedores de datos de mercado reconocidos y renovamos la información de forma continua: en el pie de página ves siempre la hora de la última actualización. Los cálculos se ejecutan en tu navegador, así que no necesitas crear una cuenta y no almacenamos tu información personal.',
    ...
    legalDataText: 'La información proviene de proveedores de datos de mercado externos, por lo que puede haber retrasos, interrupciones o diferencias frente a otras fuentes, ajenas a MarketPulse. Los cálculos se ejecutan en tu navegador y solo se guardan localmente tus preferencias (tema, idioma y caché); no operamos servidores que almacenen tu información personal.',
  ...
  en: {
    ...
    aboutSourcesText: 'We work with recognised market-data providers and refresh the information continuously: the footer always shows the time of the last update. All calculations run in your browser, so you do not need an account and we do not store your personal information.',
    ...
    legalDataText: 'Information comes from external market-data providers, so delays, outages or differences with other sources may occur and are outside MarketPulse’s control. Calculations run in your browser and only your preferences (theme, language and cache) are stored locally; we operate no servers storing your personal information.',
